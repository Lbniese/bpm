...
fn repeat_install_is_a_no_op_on_the_store() {
    ...
    // with a valid cached plan, the second run skips resolution
...
/// A fresh frozen install persists nonempty, sorted project-view
...
fn second_project_with_same_graph_reuses_the_volume() {
    // A second project that shares the same
