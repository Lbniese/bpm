...
/// after add, `.bpm-state` persists nonempty, sorted ownership that
...
/// a local-view (`BPM_PROJECT_VIEW=local`) remove must delete the
...
/// a recorded local directory that the user replaced before the next
