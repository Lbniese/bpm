...
This guide applies to all contributors. Read it alongside the current design
documents under `docs/` for the architecture and repository
conventions.

## Before you start

1. Read the current design documents under `docs/` for the area you are
   touching.
2. Look at existing tests and benchmarks for the area you're touching.
3. Classify the change:

   ```text
   A. Required for the next release
